...
class ObjectToIdentifierTransformerSpec extends ObjectBehavior
{
    ...
    {
        $repository->getClassName()->willReturn('spec\Accard\Bundle\ResourceBundle\Form\DataTransformer\FakeEntity');
        $this->beConstructedWith($repository, 'id');
    }

    function it_is_initializable()
    {
        $this->shouldHaveType('Accard\Bundle\ResourceBundle\Form\DataTransformer\ObjectToIdentifierTransformer');
    }
