...
namespace spec\Accard\Bundle\ResourceBundle\Doctrine\ORM;
...
class EntityRepositorySpec extends ObjectBehavior
{
    ...
    {
        $class->name = 'spec\Accard\Bundle\ResourceBundle\Fixture\Entity\Foo';
    ...
    {
        $this->shouldHaveType('Accard\Bundle\ResourceBundle\Doctrine\ORM\EntityRepository');
    }
    ...
    {
        $this->createNew()->shouldHaveType('spec\Accard\Bundle\ResourceBundle\Fixture\Entity\Foo');
    }
