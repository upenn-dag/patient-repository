        ...
        <div className='row-fluid'>
          <div className='col-sm-6 col'>
            <Overlay placement='top' trigger='focus' overlay={<Tooltip>Date of birth from</Tooltip>}>
              <Input type='text' bsSize='small' ref='fromDate' placeholder='yyyy-mm-dd' onChange={this._inputHandler('fromDate')} value={this.state.fromDate} />
            </Overlay>
          </div>
          <div className='col-sm-6 col'>
            <Overlay placement='top' trigger='focus' overlay={<Tooltip>Date of birth to</Tooltip>}>
              <Input type='text' bsSize='small' ref='toDate' placeholder='yyyy-mm-dd' onChange={this._inputHandler('toDate')} value={this.state.toDate} />
            </Overlay>
          </div>
        </div>
        <div className='row-fluid'>
