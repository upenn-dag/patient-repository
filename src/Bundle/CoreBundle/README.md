...
The Accard framework core bundle integrates all other bundles into the complete
framework distribution. In addition to simply providing the components & bundles,
it combines the same components & bundles for additional uses.
