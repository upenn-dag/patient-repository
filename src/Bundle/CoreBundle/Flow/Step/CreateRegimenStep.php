 ...
 */
class CreateRegimenStep extends ControllerStep
{
    /**
     * Regimen model class.
     *
     * @var string
     */
    private $regimenModelClass;

    /**
     * Constructor.
     *
     * @param string $regimenModelClass
     */
    public function __construct($regimenModelClass)
    {
        $this->regimenModelClass = $regimenModelClass;
    }
    ...
    {
        $regimen = new $this->regimenModelClass();
        ...
        $regimen->setPrototype($regimenPrototype);
