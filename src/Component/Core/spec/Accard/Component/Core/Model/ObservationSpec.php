 ...
 */
class ObservationSpec extends ModelBehavior
{
    function it_is_initializable()
    {
        $this->shouldHaveType('Accard\Component\Core\Model\Observation');
    }

    function it_implements_Accard_collection_interface()
    {
        $this->shouldImplement('Accard\Component\Core\Model\ObservationInterface');
    }
