 ...
 */
class ObservationSpec extends ObjectBehavior
{
    function it_is_initializable()
    {
        $this->shouldHaveType('Accard\Component\Activity\Model\Observation');
    }
    ...
    {
        $this->shouldImplement('Accard\Component\Activity\Model\ObservationInterface');
    }
}
